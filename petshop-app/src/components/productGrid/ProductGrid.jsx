...
const ProductGrid = () => {
    ...
    //Ceil serve para arrendodar para cima
        ...
        <div className='product-grid-container'>
            ...
            <main className='product-list-section'>
                <header className='product-list-header'>
                    <p>
                        Mostrando {indicePrimeiroProduto + 1} -{Math.min(indicePrimeiroProduto,todosProdutos.length)} de {todosProdutos.length}Resultados
                        
                    </p>
                    <div className='sort-by'>
                        <label htmlFor='sort'>ordenarpor:</label>
                        <select name='sort' id="sort">
                            <option value="defaul">Mais recente</option>
